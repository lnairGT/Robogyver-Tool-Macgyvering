...
function [action_pcl_tf, grasp_pcl_tf, min_grasp_x, max_action_x, att_point_action, att_point_grasp] = parts_orient2(action_match, grasp_match, angle_relative, pos_relative, part_location, names, num_att, att_type)
    ...
    tform_grasp = makehgtform('translate', -mean(grasp_object.Location)+[abs(pos_relative(1)),0,0]);
